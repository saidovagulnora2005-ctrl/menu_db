    ...
    while True:
        if logged_in_user == None:
            ...
            match choice:
                case 1:
                    try:
                        logged_in_user = await register(input("Username: "),input("Fullname: "),int(input("Age: ")),getpass("Enter your password: "))
                    except Exception as err:
                        print("Error in input registration: ",err)
                case 2:
                    try:
                        logged_in_user = await login(input("Username: "),getpass("Enter your password: "))
                    except Exception as err:
                        print("Error in input login: ",err)
                case 0:
                    print("You quited the program. Bye!👋")
                    break
                case _:
